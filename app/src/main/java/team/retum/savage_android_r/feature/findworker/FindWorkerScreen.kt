package team.retum.savage_android_r.feature.findworker
...
import team.retum.savage_android_r.feature.complete.CompleteScreen
import team.retum.savage_android_r.feature.loading.LoadingScreen
import team.retum.savage_android_r.feature.root.NavGroup
import team.retum.savage_android_r.ui.component.SavageBoxTextField
...
import team.retum.savage_android_r.util.setUserLocation
                        ...
                        Row {
                            ...
                            Button(
                                ...
                                modifier = Modifier
                                    ...
                                    .background(Color(0xFFF27AF62)), // 버튼의 배경 색상 설정
                                contentPadding = PaddingValues(0.dp), // 내부 컨텐츠의 패딩을 제거합니다.
                                colors = ButtonDefaults.buttonColors(
                                    contentColor = SavageColor.White,
                                    containerColor = Color(0xFFF27AF62)// 버튼 내부의 텍스트 또는 아이콘의 색상 설정
                                )
                            ) {
                                Icon(
                                    painter = painterResource(id = R.drawable.ic_clothe),
                                    contentDescription = null,
                                    tint = SavageColor.White,
                                    modifier = Modifier
